...
class RunConfig:
	...
	def __init__(self, n_epochs, init_lr, init_lr_p, init_lr_m,lr_schedule_type, lr_schedule_param,
	             dataset, train_batch_size, test_batch_size, valid_size,
	             opt_type, opt_param, weight_decay, label_smoothing, no_decay_keys,
	             mixup_alpha, model_init, validation_frequency, print_frequency):
		self.n_epochs = n_epochs
		self.init_lr = init_lr
		self.init_lr_p = init_lr_p
		self.init_lr_m = init_lr_m
	...
	def adjust_learning_rate(self, optimizer, epoch, batch=0, nBatch=None):
		...
		new_lr1 = calc_learning_rate(epoch, self.init_lr_p, self.n_epochs, batch, nBatch, self.lr_schedule_type)
		new_lr2 = calc_learning_rate(epoch, self.init_lr_m, self.n_epochs, batch, nBatch, self.lr_schedule_type)
...
class ImagenetRunConfig(RunConfig):
	...
	def __init__(self, n_epochs=150, init_lr=0.05, init_lr_p=1e-3, init_lr_m=1e-4,lr_schedule_type='cosine', lr_schedule_param=None,
		...
		super(ImagenetRunConfig, self).__init__(
			n_epochs, init_lr, init_lr_p,init_lr_m,lr_schedule_type, lr_schedule_param,
			dataset, train_batch_size, test_batch_size, valid_size,
			opt_type, opt_param, weight_decay, label_smoothing, no_decay_keys,
			mixup_alpha,
