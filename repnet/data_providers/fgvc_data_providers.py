...
class AircraftDataProvider(FGVCDataProvider):
	...
	@property
	def save_path(self):
		return os.path.expanduser('/dataset_nvme/aircraft')
...
class CarDataProvider(FGVCDataProvider):
	...
	@property
	def save_path(self):
		return os.path.expanduser('/dataset_nvme/stanford_car')
...
class Flowers102DataProvider(FGVCDataProvider):
	...
	@property
	def save_path(self):
		return os.path.expanduser('/dataset_nvme/flowers102')
...
class Food101DataProvider(FGVCDataProvider):
	...
	@property
	def save_path(self):
		return os.path.expanduser('/dataset_nvme/food101')
...
class CUB200DataProvider(FGVCDataProvider):
	...
	@property
	def save_path(self):
		return os.path.expanduser('/dataset_nvme/cub200')
...
class PetsDataProvider(FGVCDataProvider):
	...
	@property
	def save_path(self):
		return os.path.expanduser('/dataset_nvme/pets')
...
class CIFAR10DataProvider(FGVCDataProvider):
	...
	@property
	def save_path(self):
		return os.path.expanduser('/dataset_nvme/cifar10')
...
class CIFAR100DataProvider(CIFAR10DataProvider):
	...
	@property
	def save_path(self):
		return os.path.expanduser('/dataset_nvme/cifar100')
