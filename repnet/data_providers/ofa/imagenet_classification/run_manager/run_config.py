...
class RunConfig:
	...
	def __init__(self, n_epochs, init_lr, init_lr_p, lr_schedule_type, lr_schedule_param,
...
class ImagenetRunConfig(RunConfig):
	...
	def __init__(self, n_epochs=150, init_lr=0.05, init_lr_p=1e-3, lr_schedule_type='cosine', lr_schedule_param=None,
		...
		super(ImagenetRunConfig, self).__init__(
			n_epochs, init_lr, init_lr_p,lr_schedule_type, lr_schedule_param,
			dataset, train_batch_size, test_batch_size, valid_size,
			opt_type, opt_param, weight_decay, label_smoothing, no_decay_keys,
			mixup_alpha,
